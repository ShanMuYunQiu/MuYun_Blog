...
- **堆排序原理**
  ...
  > 1、**堆排序**英文名为**Heap Sort**，是利用**堆**这种**数据结构**而设计的一种排序算法  
  > 2、**堆排序**的**特点**：**堆**必须是**完全二叉树**。二叉树**每个节点的值**都**大于等于**其**左右子树节点的值**，称为**大顶堆**；或者**每个节点的值**都**小于等于**其**左右子树节点的值**，称为**小顶堆**

  ![](https://jsd.cky.codes/gh/ShengQiBaoZao/Image/duipaixu1.png)
