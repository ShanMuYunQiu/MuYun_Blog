...
title: C语言基础教程
author: 圣奇宝枣
description: 有关于C语言的基础教程，包括基本语法、基础的底层逻辑知识与一部分数据结构，比较适合有一定学习经验的初学者上手
sticky: 1
date: 2022-05-09
updated: 2022-12-20
readmore: true
...
- C 编程的**基本策略**是，用程序把**源代码**文件**转换**成**可执行文件**(其中包含可直接运行的机器语言代码)  
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cbianyi.png)
...
- **简单程序的结构**
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cjiegou.png)
...
- **整数**
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Czhengshu.png)
...
- **浮点数**
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cxiaoshu.png)
...
- **参数传递机制**因实现而异，下面以**本机系统**中的**本程序**分析参数传递。该调用告诉计算机把**变量 n1、n2、n3、n4**的值传递给程序，是一种**常见的传参方式**
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cchuancanshuoming.png)
...
- 当一个程序有**多个**`if`和`else`，**如果没有花括号**，`else`将与**离它最近**的`if`配对，除非最近的 if 被花括号括起来
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cifpeidui.png)
...
- **缓冲输入与缓冲区**
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Chuanchongqu.png)
...
- **文件结尾**
  ...
  - **操作系统检测文件结尾**
    ...
    ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cjieweibiaoji.png)
...
- **递归的基本原理**
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cdigui.png)
...
- **声明指针**
  ...
  - **声明解析**
    ...
    ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cshengmingzhizhen.png)
...
- **二维数组的声明**
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cerweishuzu.png)
...
- **指针处理数组**
  ...
  - **程序解析**
    ...
    ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cshuzuzhizhen.png)
...
- **通过指针表示二维数组的值**
  ...
  - 图片演示**指针表示法**
    ...
    ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Czhizhenbiaoshufa.png)
...
- **二进制 I/O：fread()和 fwrite()**
  ...
  - **引入介绍**
    ...
    ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cerjinzhishuchu.png)
...
- **类型声明黄金法则**
  ...
  > 详见我的另一篇博文，点击跳转：[类型声明黄金法则](https://www.shengqibaozao.eu.org/2022/08/22/%E7%B1%BB%E5%9E%8B%E5%A3%B0%E6%98%8E%E9%BB%84%E9%87%91%E6%B3%95%E5%88%99)
...
- **二进制整数**
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cerjinzhizhengshu.png)
...
- **掩码**
  ...
  - **掩码的认识与使用**
    ...
    ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cyanma.png)
...
- **链表引入**
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Clianbiaoyinru.png)
...
- **建立接口**
  ...
  - **实现接口数据表示**
    ...
    - 确定**队列**中使用**何种 C 数据形式**
      ...
      ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cduilie1.png)
    ...
    - 进一步优化**数组队列**的模型
      ...
      ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cduilie2.png)
...
- **二分查找**
  ...
  - **二分查找的原理**
    ...
    ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cerfenchazhao.png)
...
- **二叉树简介**
  ...
  ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cerchashu.png)
  ...
  - **删除项**
    ...
    - **删除节点的子节点情况讨论**
      ...
      - **没有子节点**
        ...
        ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cerchashu0.png)
      ...
      - **一个子节点**
        ...
        ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cerchashu1.png)
      ...
      - **两个子节点**
        ...
        ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cerchashu2.png)
...
- **树的思想**
  ...
  - **二叉查找树的缺陷**
    ...
    ![](https://cdn.jsdelivr.net/gh/ShengQiBaoZao/Image/Cerchashubupingheng.png)
