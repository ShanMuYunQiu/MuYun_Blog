...
- `ctype.h`的**字符测试函数**  
  ![](https://s2.loli.net/2022/06/13/mcyuH3O5YXwk7hC.png)

- `ctype.h`的**字符映射函数**  
  ![](https://s2.loli.net/2022/06/13/3OzDF5crATUHwyn.png)
...
> **章节概要**：单字符 I/O:`getchar`与`putchar`、缓冲区、完全缓冲 I/O 与行缓冲 I/O、结束键盘输入(C 处理文件的方式)
