...
- C 编程的**基本策略**是，用程序把**源代码**文件**转换**成**可执行文件**(其中包含可直接运行的机器语言代码)  
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/编译.png)
...
- **简单程序的结构**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/函数结构.png)
...
- **整数**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/整数.png)
...
- **浮点数**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/小数.png)
...
- **参数传递机制**因实现而异，下面以**本机系统**中的**本程序**分析参数传递。该调用告诉计算机把**变量 n1、n2、n3、n4**的值传递给程序，是一种**常见的传参方式**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/传参说明.png)
...
- 当一个程序有**多个**`if`和`else`，**如果没有花括号**，`else`将与**离它最近**的`if`配对，除非最近的 if 被花括号括起来
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/if配对.png)
...
- **缓冲输入与缓冲区**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/缓冲区.png)
...
- **文件结尾**
  ...
  - **操作系统检测文件结尾**
    ...
    ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/结尾标记.png)
...
- **递归的基本原理**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/递归.png)
...
- **声明指针**
  ...
  - **声明解析**
    ...
    ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/声明指针.png)
...
- **二维数组的声明**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/二维数组.png)
...
- **指针处理数组**
  ...
  - **程序解析**
    ...
    ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/数组指针.png)
...
- **通过指针表示二维数组的值**
  ...
  - 图片演示**指针表示法**
    ...
    ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/指针表示法.png)
...
- **二进制 I/O：fread()和 fwrite()**
  ...
  - **引入介绍**
    ...
    ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/二进制输出.png)
...
- **二叉树演示**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/链式结构.png)
...
- **二进制整数**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/二进制整数.png)
...
- **掩码**
  ...
  - **掩码的认识与使用**
    ...
    ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/掩码.png)
...
- **链表引入**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/链表.png)
...
- **建立接口**
  ...
  - **实现接口数据表示**
    ...
    - 确定**队列**中使用**何种 C 数据形式**
      ...
      ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/队列1.png)
    ...
    - 进一步优化**数组队列**的模型
      ...
      ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/队列2.png)
...
- **二分查找**
  ...
  - **二分查找的原理**
    ...
    ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/二分查找.png)
...
- **二叉树简介**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/二叉树.png)
  ...
  - **删除项**
    ...
    - **删除节点的子节点情况讨论**
      ...
      - **没有子节点**
        ...
        ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/二叉树0.png)
      ...
      - **一个子节点**
        ...
        ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/二叉树1.png)
      ...
      - **两个子节点**
        ...
        ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/二叉树2.png)
...
- **树的思想**
  ...
  - **二叉查找树的缺陷**
    ...
    ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/C语言基础教程/二叉树不平衡.png)
