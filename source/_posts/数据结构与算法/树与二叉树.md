...
- **认识树结构**
  ...
  > 2、**节点**：每个**数据**就是一个**节点**。**节点**可分为**根节点**、**分支节点**、**叶子结点**。在**两个节点的关系**上分为**前驱**(父节点)和**后继**(子节点)  
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/算法/树.png)
...
- **孩子兄弟表示法(链式-二叉链表)**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/算法/树2.png)
...
- **二叉树与满二叉树**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/算法/二叉树.png)
...
- **常见的树：完全二叉树**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/算法/完全二叉树.png)
...
- **前序遍历**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/算法/前序线索二叉树.png)
...
- **中序遍历**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/算法/中序线索二叉树.png)
...
- **后序遍历**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/算法/后序线索二叉树.png)
...
- **从树快速得到遍历**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/算法/二叉树树推序.png)
...
- **从遍历推导树**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/算法/二叉树序推树.png)
