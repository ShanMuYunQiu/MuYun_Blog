...
- **启发式合并**
  ...
  > 3、先前的**路径压缩**虽然更快但会破坏**图的结构**，如果要**保留原图**且**追求速度**，只能使用**启发式合并**。**启发式合并**的**小指向大**保证了**非必要时不增加查询层数**，使得操作次数最多不会超过 $\log$ 次，因而降低了**朴素**`root()`的**时间复杂度**至 $O(\log n)$。此外，**路径压缩**不能撤销(回到上一步)，因为其**破坏了原图**
...
- **带权并查集**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/%E7%AE%97%E6%B3%95/%E5%B8%A6%E6%9D%83%E5%B9%B6%E6%9F%A5%E9%9B%86.png)
