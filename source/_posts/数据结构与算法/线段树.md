...
- **加法线段树**
  ...
  ![](https://jsd.vxo.im/gh/ShanMuYunQiu/Image/blog/%E7%AE%97%E6%B3%95/%E7%BA%BF%E6%AE%B5%E6%A0%91%E7%BB%93%E6%9E%84.png)
...
- **代码实现**
  ...
  void pushdown(int s, int e, int o)
  {
      ...
      int mid = (s + e) >> 1;
      update(s, mid, o << 1, lz[o]);          // 向左子节点下放 lz
      update(mid + 1, e, o << 1 | 1, lz[o]);  // 向右子节点下放 lz
